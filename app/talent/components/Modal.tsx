...
const Modal = () => {
  return (
    <div className="flex flex-col p-14 w-[450px] justify-center gap-4 bg-white rounded-xl">
      ...
      <div className="flex gap-4 flex-col justify-center w-full items-center">
        <p className="text-xl font-bold text-center">Join our Whatsapp community</p>
        <p className="text-center">Get notified on the latest projects and hackathon</p>
      </div>
      <div className="flex w-full justify-center">
