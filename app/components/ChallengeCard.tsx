...
const ChallengeCard = () => {
  return (
    <div className="flex flex-col border-[1.5px] items-start pt-[18px] rounded-[10px] w-[350px] h-auto border-[#E4E7EC] py-12 px-4">
      ...
      <h2 className="text-[#101928] mt-[30px] mb-4 text-[20px] font-semibold">
        ...
        <div className="flex flex-wrap mt-4 gap-[10px] items-start justify-start mb-4">
      ...
      <div className="space-x-[10px] mt-[10px] items-center justify-center">
        <h2 className="text-[#25272B] text-[14px] font-semibold">
          Seniority Level:
        </h2>
      ...
      <div className="flex-1 w-full border-t-[1.5px] flex items-center px-[20px] border-[#E4E7EC] mt-[16px]">
        <button className="bg-[#2B71F0] text-[13px] font-semibold text-white h-auto w-[136px] rounded-[10px]">
          View Challenge
        </button>
      </div>
    </div>
