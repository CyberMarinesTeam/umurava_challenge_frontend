...
export default function Home() {
  return (
    <div className="">
      ...
      <main className="flex   flex-row items-center justify-center space-x-[10px] mt-[50px] ">
      ...
      <main className="flex flex-col space-y-[20px] pb-[50px] bg-[#F9FAFB] items-center pt-[50px] justify-center">
